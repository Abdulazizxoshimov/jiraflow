...
func New(d Deps) *UseCases {
	...
	telegramUC := telegram_uc.New(d.Store.Telegram, d.Store.Issue, d.Cache, tgClient, d.TelegramWebhookURL, d.TelegramWebhookSecret, d.TelegramBotUsername)
	...
	return &UseCases{
		...
		Workflow:           workflow.New(d.Store.Workflow, d.Cache, d.Log),
		Project:            project.New(d.Store.Project, d.Store.Workflow, d.Store.Space, d.Store.Board, d.Cache, d.Log),
		ProjectMember:      project_member.New(d.Store.ProjectMember, d.Store.Project, d.Log),
		Invite:             invite.New(d.Store.Invite, d.Store.User, d.TokenMaker, d.Hasher, d.EmailSender, d.FrontendBaseURL, d.Log),
		Sprint:             sprint.New(d.Store.Sprint, d.Store.Issue, d.Store.Space, d.Store.Page, d.Store.PageVersion, d.Store.ProjectMember, disp, d.Log),
		Issue:              issue.New(d.Store.Issue, d.Store.Project, d.Store.Workflow, d.Store.Version, d.Store.ProjectMember, disp, d.Hub, d.Log),
		...
		Favorite:           favorite.New(d.Store.Favorite, d.Store.Page, d.Store.Space, d.Store.Issue, d.Log),
		...
		PageLock:           page_lock.New(d.Store.PageLock, d.Hub),
